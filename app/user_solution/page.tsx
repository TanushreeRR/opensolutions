...
export default function EntriesPage() {
  ...
  const handleClick = () => {
    router.push("/form_solution");
  }

  return (
    <div className="flex min-h-screen flex-col  bg-[#1c1c62] text-white">
     <div style={{ marginTop: '20px' }}>
  <p>Show your problem solving skills by proposing solution approach to any of the ideas mentioned below!</p>
  <div className='mt-0.5'>
  <p>Submit your solution by clicking below (Include the idea name in title, and the solution in description)</p>
  </div>
  <button onClick={handleClick} className="px-4 py-2 rounded-full bg-[#6666ee] text-white hover:bg-blue-600 mt-5">Click here to submit</button>
      ...
      <h1 style={{marginTop: '75px', marginLeft: '20px', fontWeight: 'bold', fontSize: '22px' }}>Ideas to work on:</h1>
