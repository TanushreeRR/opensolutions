...
export default function EntriesPage() {
  ...
  const handleClick = () => {
    router.push("/admin_forms/idea_form");
  };
  ...
  return (
    <div className="flex min-h-screen flex-col  bg-[#1c1c1c] text-white">
      <div style={{ marginTop: '20px' }}>
        <button onClick={handleClick} className="px-6 py-2 text-2xl rounded-full bg-[#4d4dd3] text-white hover:bg-blue-500 mt-5">Add new idea</button>
      </div>

      <h1 style={{marginTop: '50px', marginLeft: '20px', fontWeight: 'bold', fontSize: '22px' }}>Modify ideas:</h1>
